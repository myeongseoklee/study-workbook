...
│   ├── ep06-coding-agent-finale/ ← 강의 #6 (이벤트 소싱·캐시·AI 협업)
...
| #6 | `ep06-coding-agent-finale/` | 이벤트 소싱 에이전트의 운영 원리·프리픽스/KV 캐시 진단·AI 협업 원칙 | [코딩에이전트 만들기 #6(끝)](https://www.youtube.com/live/vMXq7J0zeU0) (라이브, 약 1h35m) |
...
| 2026-09-04 | #6 | `ep06-coding-agent-finale/` 추가 (본문 5파일 + 캡처 4장). 워크북 `100`/`101`과 이벤트 리플레이 코딩 과제 추가. 자동 자막 기반 `full-subtitle`. |
