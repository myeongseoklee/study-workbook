...
파트 1은 [`../docs/90-must-memorize.md`](../docs/90-must-memorize.md)의 **1·2강 항목 46개와 1:1 대응**한다. 3강 카드(`#3`)는 성격이 달라 이 파일이 다루지 않는다 — [`94-workbook-ep03.md`](94-workbook-ep03.md)가 **대조표 복원·스킬 문장 고쳐쓰기** 형태로 다룬다. 회차가 쌓이면 카드도 쌓이므로 권장 상한(20문항)을 넘는다. 대신 **강의별·주제별 8묶음(A~H)** 으로 나눴으니 한 번에 한 묶음씩 풀면 된다. 1강만 들었다면 A~D까지만 풀면 된다.
