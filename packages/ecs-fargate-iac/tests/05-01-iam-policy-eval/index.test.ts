 ...
 *
 * 이 파일이 과제의 정의다. `src/05-01-iam-policy-eval/index.ts`를 채워 여기를 통과시켜라.
...
import { conditionHolds, evaluate, matchesPattern, type Statement } from '../../src/05-01-iam-policy-eval';
