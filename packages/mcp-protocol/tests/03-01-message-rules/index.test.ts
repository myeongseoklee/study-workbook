 ...
 *
 * 이 파일이 과제의 정의다. `src/03-01-message-rules/index.ts`를 채워 여기를 통과시켜라.
...
import { classifyErrorCode, classifyMessage, interpretResultType } from '../../src/03-01-message-rules';
