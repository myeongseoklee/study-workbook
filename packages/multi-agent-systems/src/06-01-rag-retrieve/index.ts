 ...
 *
 * 명세: tests/06-01-rag-retrieve/index.test.ts (먼저 읽어라)
 * 막히면 정답: solutions/06-01-rag-retrieve/index.ts
 */
...
export function retrieve(query: string, docs: string[] = DOCS, k = 2): string[] {
  ...
  throw new Error("TODO: retrieve 구현. 막히면 solutions/06-01-rag-retrieve/index.ts 참고");
}
...
export async function answer(query: string, askFn: Ask, docs: string[] = DOCS): Promise<string> {
  ...
  throw new Error("TODO: answer 구현. 막히면 solutions/06-01-rag-retrieve/index.ts 참고");
}
