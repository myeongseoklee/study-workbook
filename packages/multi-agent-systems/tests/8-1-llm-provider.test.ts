// 이 파일은 고치지 않는다 — 명세다. 통과시키려면 ../src/8-1-llm-provider.ts를 고쳐라.
import { describe, expect, it } from "vitest";
import { scripted } from "@study/testkit";
import { anthropicProvider } from "../src/8-1-llm-provider";
import type { AnthropicClient } from "../src/8-1-llm-provider";
